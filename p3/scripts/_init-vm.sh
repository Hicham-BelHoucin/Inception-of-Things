...
VM_NAME="Inception-Of-Things_P3"
...
VBoxManage storageattach "${VM_NAME}" --storagectl "SATA Controller" --port 2 --device 0 --type hdd --medium /Users/sel-mars/goinfre/VirtualBox/${VM_NAME}/ubuntu-autoinstall.vmdk
...
# Enable serial port
VBoxManage modifyvm "${VM_NAME}" --uart1 0x3F8 4 --uartmode1 server /tmp/serial-port
# Start the VM
